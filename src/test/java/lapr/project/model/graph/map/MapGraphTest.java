package lapr.project.model.graph.map;
...
public class MapGraphTest {
    ...
    public void testValidVertex() {
        assertEquals(false, instance.removeEdge("B", "Z"));
        assertEquals(false, instance.removeEdge("Z", "B"));
        assertEquals(false, instance.removeEdge("Z", "Z"));
        instance.addVertex("B");
        assertEquals(false, instance.addVertex("B"));
        assertEquals(null, instance.incomingEdges("Z"));
        assertEquals(null, instance.outgoingEdges("Z"));
        assertEquals(null, instance.adjVertices("Z"));
    ...
    void testToString() {
        ...
        assertEquals("\nGraph not defined!!", instance.toString());
